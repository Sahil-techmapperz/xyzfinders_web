            ...
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="md:hidden relative h-[300px] w-full rounded-2xl overflow-hidden bg-white group">
                        {furniture.images[activeImage] ? (
                            <img
                                src={furniture.images[activeImage]}
                                alt={`${furniture.title} - View ${activeImage + 1}`}
                        ...
                        {furniture.images.length > 1 && (
                            <>
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setActiveImage(prev => prev === 0 ? furniture.images.length - 1 : prev - 1);
                                    }}
                                ...
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setActiveImage(prev => prev === furniture.images.length - 1 ? 0 : prev + 1);
                                    }}
                        ...
                        <div className="absolute bottom-3 right-3 bg-black/60 text-white text-xs font-bold px-3 py-1.5 rounded-full backdrop-blur-md flex items-center gap-1.5">
                            ...
                            {activeImage + 1} / {furniture.images.length}
                        </div>
                    </div>
                        ...
                        <div className="bg-linear-to-r from-[#FF8A65] to-[#FF7043] rounded-2xl p-4 md:p-6 mb-6 md:mb-8 shadow-lg">
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <div className="text-2xl md:text-4xl font-bold text-white">{furniture.price}</div>
                                </div>
                    ...
                    <div className="xl:col-span-1">
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100">
                                ...
                                <p className="text-[10px] text-gray-400 mb-4 md:mb-6">Member Since {furniture.seller.memberSince}</p>
