...
function PetsCreateForm() {
    ...
    const handleSubmit = async () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'category', 'breed', 'gender', 'city', 'state'];
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-bear-smile-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Pet' : 'Pets & Accessories'}</span>
                        </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g., Golden Retriever Puppies, Aquarium Tank"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            >
                                                ...
                                                <option value="Accessory">Pet Accessory</option>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe the pet details, habits, history, or product details..."
                                        ></textarea>
                    ...
                    {currentStep === 2 && (
                        <div className="space-y-6 animate-fadeIn">
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <label className="block text-gray-700 font-semibold mb-2">Breed / Type*</label>
                                        <input
                                            type="text"
                                            name="breed"
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                            placeholder="e.g., Labrador, Siamese, Goldfish"
                                        />
                                    </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="mb-4 p-4 bg-orange-50 rounded-xl border border-orange-200">
                                    <div className="flex items-start gap-3">
                                        <i className="ri-lightbulb-line text-orange-600 text-xl mt-0.5"></i>
                                        <div>
                                            <h4 className="font-semibold text-orange-900 mb-1">Tips for great photos</h4>
                                            <ul className="text-sm text-orange-700 space-y-1">
                                                <li>• Use natural light for clear pet photos</li>
                                                <li>• Show the pet from multiple angles</li>
                                                <li>• Include photos of parents if available</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
