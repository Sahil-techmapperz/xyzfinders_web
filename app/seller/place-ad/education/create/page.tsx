...
export default function EducationCreatePage() {
    ...
    const handlePillSelect = (field: 'level' | 'mode', value: string) => {
    ...
    const handleSubmit = () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'subject', 'level', 'mode', 'city', 'state'];
        ...
        console.log('Education listing submitted:', formData);
        alert('Form submitted successfully! Check console for data.');
    };

    const levelOptions = ['School', 'College', 'Competitive Exams', 'Professional'];
        ...
        <div className="bg-[#FFFBF7] min-h-screen font-jost pb-16">
            ...
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                <div className="text-center mb-8">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">List Your Teaching Service</h1>
                    <p className="text-gray-600 text-sm md:text-base">Share your expertise with students</p>
                </div>
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500 mb-8 font-medium flex-wrap">
                    ...
                    <span className="text-brand-orange">Education & Learning</span>
                </div>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., Mathematics Tuition for Class 10"
                        />
                    </div>

                    <div>
                        <label className="block text-gray-700 font-medium mb-2">Subject/Course*</label>
                        <input
                            type="text"
                            name="subject"
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-orange/20 focus:border-brand-orange transition"
                            placeholder="e.g., Mathematics, Physics, IELTS"
                        />
                    </div>

                    <div>
                        <label className="block text-gray-700 font-medium mb-3">Level*</label>
                        <div className="flex flex-wrap gap-3">
                            {levelOptions.map(option => (
                                <button
                                    key={option}
                                    type="button"
                                    onClick={() => handlePillSelect('level', option)}
                                    className={`px-5 py-2 rounded-full border-2 font-medium transition ${formData.level === option
                    ...
                    <div>
                        <label className="block text-gray-700 font-medium mb-3">Mode of Teaching*</label>
                        <div className="flex flex-wrap gap-3">
                            {modeOptions.map(option => (
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-full border-2 font-medium transition ${formData.mode === option
                                            ? 'bg-brand-orange text-white border-brand-orange'
                                            : 'bg-white text-gray-700 border-gray-200 hover:border-brand-orange'
                                        }`}
                                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-orange/20 focus:border-brand-orange transition"
                            placeholder="Enter price (per hour/month)"
                        />
                    </div>
