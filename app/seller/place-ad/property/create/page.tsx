...
function PropertyCreateForm() {
    ...
    const handleSubmit = async () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'category', 'propertyType', 'bedrooms', 'area', 'furnished', 'city', 'state'];
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-building-4-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Property' : 'Property'}</span>
                        </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-gray-700 font-semibold mb-2">Bathrooms (Optional)</label>
                                            <input
                                                type="text"
                                                name="bathrooms"
                                    ...
                                    <div>
                                        <label className="block text-gray-700 font-semibold mb-3">Furnished Status*</label>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-sm text-blue-700 space-y-1">
                                                <li>• Capture all rooms and common areas</li>
                                                <li>• Include balcony, parking, and amenities</li>
                                                <li>• Use good lighting for interior shots</li>
                                    ...
                                    >
                                        {loading ? (
                                            ...
                                            <>
                                                ...
                                                {isEditMode ? 'Update Property' : 'Publish Listing'}
                                            </>
                                        )}
                                    </button>
                                </div>
