...
function FurnitureCreateForm() {
    ...
    const handleSubmit = async () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'category', 'material', 'condition', 'city', 'state'];
        ...
        try {
            ...
            if (data.success) {
                toast.success(isEditMode ? 'Listing updated successfully!' : 'Item listed successfully!');
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-sofa-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Ad' : 'Furniture'}</span>
                        </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g., Wooden King Size Bed with Storage"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe the furniture condition, dimensions, material, features..."
                                        ></textarea>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                            placeholder="e.g., Teak Wood, Sheesham, Steel"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-sm text-blue-700 space-y-1">
                                                <li>• Clean and arrange the furniture before photographing</li>
                                                <li>• Show all angles and detailing</li>
