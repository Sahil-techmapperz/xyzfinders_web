...
function JobsCreateForm() {
    ...
    const handlePillSelect = (field: 'jobType', value: string) => {
    ...
    const handleSubmit = async () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'category', 'companyName', 'jobType', 'city', 'state'];
        ...
        // Images are optional for jobs, but we'll keep it consistent or make it optional? 
        // Let's enforce 1 image like company logo or office photo for better engagement
        if (images.length === 0) {
            toast.error('Please upload at least one image (e.g., Company Logo)');
            return;
        }
    ...
    const jobTypeOptions = ['On-site', 'Remote', 'Hybrid'];

    const steps = [
        { number: 1, title: 'Job Info', icon: 'ri-briefcase-line' },
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-briefcase-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Job' : 'Jobs & Career'}</span>
                        </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe roles & responsibilities, requirements, benefits..."
                                        ></textarea>
                                        <div className="flex justify-between items-center mt-2">
                                            <span className="text-sm text-gray-400">Be detailed to attract quality candidates</span>
                        ...
                        <div className="space-y-6 animate-fadeIn">
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-gray-700 font-semibold mb-2">Experience Level (Optional)</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-gray-700 font-semibold mb-3">Work Mode*</label>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="mb-4 p-4 bg-sky-50 rounded-xl border border-sky-200">
                                    <div className="flex items-start gap-3">
                                        <i className="ri-lightbulb-line text-sky-600 text-xl mt-0.5"></i>
                                        <div>
                                            <h4 className="font-semibold text-sky-900 mb-1">Tips for job posts</h4>
                                            <ul className="text-sm text-sky-700 space-y-1">
                                                <li>• Upload Company Logo for better visibility</li>
                                                <li>• Add photos of the office or team</li>
                                                <li>• Images help attract serious candidates</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
