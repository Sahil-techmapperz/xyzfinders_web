...
function GadgetsCreateForm() {
    ...
    return (
        <div className="min-h-screen font-jost bg-linear-to-br from-blue-50 via-white to-purple-50">
            {/* Header */}
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-cpu-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Ad' : 'Gadgets & Electronics'}</span>
                        </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe the product condition, features, accessories included..."
                                        ></textarea>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                                placeholder="e.g., Sony, Nikon, Dell"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                                placeholder="e.g., WH-1000XM5, D5600"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-gray-700 font-semibold mb-2">Battery Life (Optional)</label>
                                            <input
                                                type="text"
                                                name="batteryLife"
                                    ...
                                    <div>
                                        <label className="block text-gray-700 font-semibold mb-2">Connectivity (Optional)</label>
                                        <input
                                            type="text"
                                            name="connectivity"
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                            placeholder="e.g., Bluetooth 5.0, Wi-Fi 6, USB-C"
                                        />
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-sm text-blue-700 space-y-1">
                                                ...
                                                <li>• Include any defects or wear honestly</li>
...
export default function GadgetsCreatePage() {
    return (
