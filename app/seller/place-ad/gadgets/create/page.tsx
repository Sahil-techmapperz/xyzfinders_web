...
export default function GadgetsCreatePage() {
    ...
    const handleSubmit = () => {
        ...
        console.log('Gadget listing submitted:', formData);
        ...
        <div className="bg-[#FFFBF7] min-h-screen font-jost pb-16">
            ...
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                <div className="text-center mb-8">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">List Your Gadget</h1>
                    <p className="text-gray-600 text-sm md:text-base">Share details about your electronics</p>
                </div>
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500 mb-8 font-medium flex-wrap">
                    ...
                    <span className="text-brand-orange">Gadgets & Electronics</span>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label className="block text-gray-700 font-medium mb-3">Warranty Status*</label>
                        <div className="flex flex-wrap gap-3">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Describe the condition, features, accessories..."
                        ></textarea>
