...
export default function ServicesCreatePage() {
    ...
    const handlePillSelect = (field: 'availability', value: string) => {
    ...
    const handleSubmit = () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'serviceType', 'city', 'state'];
        ...
        console.log('Service listing submitted:', formData);
        ...
        <div className="bg-[#FFFBF7] min-h-screen font-jost pb-16">
            ...
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                <div className="text-center mb-8">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">List Your Service</h1>
                    <p className="text-gray-600 text-sm md:text-base">Showcase your skills and expertise</p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Home Services">Home Services (Plumber, Electrician, Cleaning)</option>
                    ...
                    <div>
                        <label className="block text-gray-700 font-medium mb-3">Availability</label>
                        <div className="flex flex-wrap gap-3">
                            {availabilityOptions.map(option => (
                                <button
                                    key={option}
                                    type="button"
                                    onClick={() => handlePillSelect('availability', option)}
                                    className={`px-5 py-2 rounded-full border-2 font-medium transition ${formData.availability === option
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-orange/20 focus:border-brand-orange transition"
                            placeholder="Enter price (per hour/day/project)"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Describe your services, expertise, certifications..."
                        ></textarea>
                        <div className="text-right text-sm text-gray-400 mt-1">{charCount}/{maxChars}</div>
                    </div>

                    <div className="pt-4">
                        <h2 className="text-lg font-bold text-gray-900 mb-4">Service Location*</h2>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 font-medium mb-2">Service Area/Landmark</label>
                            <input
                                type="text"
                                name="landmark"
