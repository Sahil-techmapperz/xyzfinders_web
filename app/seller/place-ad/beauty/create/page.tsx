...
function BeautyCreateForm() {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setFormData({
                    ...
                    serviceType: product.service_type || specs.type || '',
                    duration: product.duration || specs.duration || '',
                    genderPreference: product.gender_preference || specs.serviceFor || specs.genderPreference || '',
    ...
    const handlePillSelect = (field: 'genderPreference', value: string) => {
    ...
    const handleSubmit = async () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'category', 'serviceType', 'city', 'state'];
    ...
    return (
        <div className="min-h-screen font-jost bg-linear-to-br from-pink-50 via-white to-rose-50">
                ...
                <div className="container mx-auto px-4 py-4 max-w-5xl">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <i className="ri-heart-pulse-line text-2xl text-brand-orange"></i>
                            <span className="font-bold text-gray-900">{isEditMode ? 'Edit Service' : 'Beauty & Wellness'}</span>
                        </div>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="e.g., Bridal Makeup Package, Hair Spa Service"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Describe the service details, products used, benefits..."
                                        ></textarea>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange transition"
                                            placeholder="e.g., Facial, Haircut, Manicure"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-gray-700 font-semibold mb-3">Gender Preference*</label>
                                            <div className="grid grid-cols-3 gap-2">
                                                {genderOptions.map(option => (
                                                    <button
                                                        key={option}
                                                        type="button"
                                                        onClick={() => handlePillSelect('genderPreference', option)}
                                                        className={`px-3 py-3 rounded-xl border-2 font-semibold text-sm transition-all ${formData.genderPreference === option
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                                ...
                                <div className="mb-4 p-4 bg-pink-50 rounded-xl border border-pink-200">
                                    <div className="flex items-start gap-3">
                                        <i className="ri-lightbulb-line text-pink-600 text-xl mt-0.5"></i>
                                        <div>
                                            <h4 className="font-semibold text-pink-900 mb-1">Tips for great photos</h4>
                                            <ul className="text-sm text-pink-700 space-y-1">
                                                <li>• Showcase the results of your services</li>
                                                <li>• Include photos of your salon or spa setup</li>
                                                <li>• Use good lighting to highlight details</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
export default function BeautyCreatePage() {
    return (
