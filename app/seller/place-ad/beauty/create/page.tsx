...
export default function BeautyCreatePage() {
    ...
    const handlePillSelect = (field: 'forGender', value: string) => {
    ...
    const handleSubmit = () => {
        const requiredFields = ['title', 'phone', 'price', 'description', 'serviceCategory', 'forGender', 'city', 'state'];
        ...
        console.log('Beauty listing submitted:', formData);
        ...
        <div className="bg-[#FFFBF7] min-h-screen font-jost pb-16">
            ...
            <div className="container mx-auto px-4 py-8 max-w-2xl">
                <div className="text-center mb-8">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">List Your Beauty Service</h1>
                    <p className="text-gray-600 text-sm md:text-base">Showcase your salon or beauty services</p>
                </div>
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500 mb-8 font-medium flex-wrap">
                    ...
                    <span className="text-brand-orange">Beauty & Well Being</span>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <label className="block text-gray-700 font-medium mb-3">For*</label>
                        <div className="flex flex-wrap gap-3">
                            {genderOptions.map(option => (
                                <button
                                    key={option}
                                    type="button"
                                    onClick={() => handlePillSelect('forGender', option)}
                                    className={`px-6 py-2 rounded-full border-2 font-medium transition ${formData.forGender === option
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Describe your services, specializations, products used..."
                        ></textarea>
                    ...
                    <div className="pt-4">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-orange/20 focus:border-brand-orange transition"
                                placeholder="Salon location or service area"
                            />
                        </div>
                    </div>
